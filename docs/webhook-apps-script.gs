...
const TEXTOS_SEMILLA = [
  ...
  ["ses3_b4", "30 minutos en videollamada con un arquitecto Aurum, con referencias reales del estilo que elegiste", "Cierre (v3): beneficio 4"],
  ...
  ["r2_reaseguro", "Videollamada de 30 min \u00b7 sin compromiso \u00b7 puedes reagendar. Recibir\u00e1s la invitaci\u00f3n con el enlace de la videollamada en tu correo.", "Cierre: reaseguros bajo el calendario"],
